...
<main>
    ...
    <div class="container">
        <div class="container-fluid text-center">
            ...
            <a href="login.php" class="link-secondary fs-3 fw-bold"> > REGÍSTRATE AHORA < </a>

                    <!--  CUENTA ATRAS DE LA PROMOCIÓN -->
                    <?php
                    $fechaFinalOferta = date('2022-04-19');
                    $horaFinalOferta = date('21:00:00');
                    $fechayHoraFinalOferta = $fechaFinalOferta . ' ' . $horaFinalOferta;
                    ?>

                    <script type="text/javascript">
                        // Intervalo de tiempo
                        const tiempoFinal = "<?php echo $fechayHoraFinalOferta; ?>";
                    ...
                    <p id="cuentaAtras" class=" bg-dark text-white rounded fs-1 fw-bolder text-uppercase"></p>
        </div>
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col">
                    <figure class="text-center">
                        <img src="img/person_1.jpg" class="rounded pb-2" alt="...">
                ...
                <div class="col">
                    <figure class="text-center">
                        <img src="img/person_2.jpg" class="rounded pb-2" alt="...">
                        <blockquote class="blockquote">
                            <p>A well-known quote, contained in a blockquote element.</p>
                        </blockquote>
                        <figcaption class="blockquote-footer">
                ...
                <div class="col">
                    <figure class="text-center">
                        <img src="img/person_3.jpg" class="rounded pb-2" alt="...">
                        <blockquote class="blockquote">
                            <p>A well-known quote, contained in a blockquote element.</p>
                        </blockquote>
                        <figcaption class="blockquote-footer">
